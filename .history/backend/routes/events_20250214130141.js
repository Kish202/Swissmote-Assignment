...
router.get('/my-events/:eventId', protect,checkEventOwnership getEventForEdit);

// Update event (Protected route)
router.put('/my-events/:eventId', protect, checkEventOwnership, validateEventUpdate, updateEvent);
